...
export default function ThisAdHelpsKeepFree(props: {size?: string, disableAbsolute?: boolean}) {
    const {subscribed} = useSelector(x => x.auth)
    let dm = useColorScheme() === 'dark'
    if (subscribed) return <View />;
    return (
        <View style={{...tw`mx-2 items-center justify-center pt-1 pb-3 rounded-xl`, backgroundColor: dm ? _tokens.dark1 : _tokens.gray50 }}>
